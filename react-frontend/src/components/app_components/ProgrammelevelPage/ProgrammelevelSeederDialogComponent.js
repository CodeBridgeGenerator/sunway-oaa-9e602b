...
import seederData from "./programmelevel.seeder.json";
...
const ProgrammelevelSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ProgrammelevelSeederDialogComponent);
