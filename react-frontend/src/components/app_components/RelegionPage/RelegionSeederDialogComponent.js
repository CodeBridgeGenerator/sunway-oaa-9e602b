...
import seederData from "./relegion.seeder.json";
...
const RelegionSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(RelegionSeederDialogComponent);
