    ...
    client
      ...
      .catch((error) => {
        ...
        props.alert({
          title: "Relegion",
          type: "error",
          message: error.message || "Failed get Relegion",
        });
      });
