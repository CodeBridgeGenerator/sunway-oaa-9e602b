...
import seederData from "./campus.seeder.json";
...
const CampusSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(CampusSeederDialogComponent);
