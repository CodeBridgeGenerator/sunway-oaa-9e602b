...
const SingleCampusPage = (props) => {
  ...
  const [isHelpSidebarVisible, setHelpSidebarVisible] = useState(false);
    ...
    useEffect(() => {
        ...
        client
            .service("campus")
            .get(urlParams.singleCampusId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
    ...
    }, [props,urlParams.singleCampusId]);
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                {/* <p>campus/{urlParams.singleCampusId}</p> */}
            </div>
      ...
      <CommentsSection
        recordId={urlParams.singleCampusId}
        user={props.user}
        alert={props.alert}
        serviceName="campus"
      />
...
export default connect(mapState, mapDispatch)(SingleCampusPage);
