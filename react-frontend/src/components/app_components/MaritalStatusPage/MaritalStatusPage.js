...
const MaritalStatusPage = (props) => {
    ...
    client
      ...
      .catch((error) => {
        ...
        props.alert({
          ...
          type: "error",
          message: error.message || "Failed get Marital Status",
        });
      });
  ...
  const deleteAll = async () => {
    ...
    const promises = data.map((e) =>
      client.service("maritalStatus").remove(e._id),
    );
    await Promise.all(
      promises.map((p) =>
        p.catch((error) => {
