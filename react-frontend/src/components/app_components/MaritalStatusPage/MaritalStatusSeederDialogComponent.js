...
import seederData from "./maritalStatus.seeder.json";
...
const MaritalStatusSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(MaritalStatusSeederDialogComponent);
