...
import seederData from "./contactInformation.seeder.json";
...
const ContactInformationSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ContactInformationSeederDialogComponent);
