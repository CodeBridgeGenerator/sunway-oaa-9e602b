...
const ContactInformationCreateDialogComponent = (props) => {
  ...
  useEffect(() => {
    ...
    if (!_.isEmpty(props?.entity)) {
      init = initilization(
        { ...props?.entity, ...init },
        [name, relationship, emergencyContactRelationship],
        setError,
      );
    }
    set_entity({ ...init });
  ...
  const validate = () => {
    ...
    if (_.isEmpty(_entity?.fullCorrespondenceAddress)) {
      error["fullCorrespondenceAddress"] =
        `Full Correspondence Address field is required`;
      ret = false;
    }
    ...
    if (_.isEmpty(_entity?.parentGuardianNumber)) {
      error["parentGuardianNumber"] =
        `Parent Guardian Number field is required`;
      ret = false;
    }
    ...
    if (_.isEmpty(_entity?.parentGuardianOfficeNumber)) {
      error["parentGuardianOfficeNumber"] =
        `Parent Guardian Office Number field is required`;
      ret = false;
    }

    if (_.isEmpty(_entity?.monthlyHouseholdIncome)) {
      error["monthlyHouseholdIncome"] =
        `Monthly Household Income field is required`;
      ret = false;
    }
  ...
  const onSave = async () => {
    ...
    try {
      ...
      const eagerResult = await client.service("contactInformation").find({
        query: {
          $limit: 10000,
          _id: { $in: [result._id] },
          $populate: [
      ...
      props.alert({
        type: "success",
        title: "Create info",
        message: "Info Contact Information updated successfully",
      });
      ...
      props.alert({
        type: "error",
        title: "Create",
        message: "Failed to create in Contact Information",
      });
    }
    setLoading(false);
  };
    ...
    client
      ...
      .find({
        query: {
          $limit: 10000,
          $sort: { createdAt: -1 },
          _id: urlParams.singleRelationshipId,
        },
      })
      .then((res) => {
        setRelationship(
      ...
      .catch((error) => {
        ...
        props.alert({
          title: "Relationship",
          type: "error",
          message: error.message || "Failed get relationship",
        });
      });
  }, []);
  ...
  const relationshipOptions = relationship.map((elem) => ({
    name: elem.name,
    value: elem.value,
  }));
  const emergencyContactRelationshipOptions = emergencyContactRelationship.map(
    (elem) => ({ name: elem.name, value: elem.value }),
  );

  return (
    <Dialog
      header="Create Contact Information"
      visible={props.show}
      closable={false}
      onHide={props.onHide}
      modal
    ...
    >
      <div
        ...
        style={{ maxWidth: "55vw" }}
        role="contactInformation-create-dialog-component"
      >
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            <label htmlFor="fullCorrespondenceAddress">
              Full Correspondence Address:
            </label>
            <InputText
              id="fullCorrespondenceAddress"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.fullCorrespondenceAddress}
              onChange={(e) =>
                setValByKey("fullCorrespondenceAddress", e.target.value)
              }
              required
            />
          </span>
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              ...
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.studentMobileNumber}
              onChange={(e) =>
                setValByKey("studentMobileNumber", e.target.value)
              }
              required
            />
          </span>
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              id="studentemail"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.studentemail}
              onChange={(e) => setValByKey("studentemail", e.target.value)}
              required
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              id="permanentAddress"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.permanentAddress}
              onChange={(e) => setValByKey("permanentAddress", e.target.value)}
              required
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              ...
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.parentGuardianName}
              onChange={(e) =>
                setValByKey("parentGuardianName", e.target.value)
              }
              required
            />
          </span>
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <Dropdown
              id="relationship"
              value={_entity?.relationship?._id}
              optionLabel="name"
              optionValue="value"
              options={relationshipOptions}
              onChange={(e) => setValByKey("relationship", { _id: e.value })}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            <label htmlFor="parentGuardianNumber">
              Parent Guardian Number:
            </label>
            <InputText
              id="parentGuardianNumber"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.parentGuardianNumber}
              onChange={(e) =>
                setValByKey("parentGuardianNumber", e.target.value)
              }
              required
            />
          </span>
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              ...
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.parentGuardianEmail}
              onChange={(e) =>
                setValByKey("parentGuardianEmail", e.target.value)
              }
              required
            />
          </span>
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            <label htmlFor="parentGuardianOfficeNumber">
              Parent Guardian Office Number:
            </label>
            <InputText
              id="parentGuardianOfficeNumber"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.parentGuardianOfficeNumber}
              onChange={(e) =>
                setValByKey("parentGuardianOfficeNumber", e.target.value)
              }
              required
            />
          </span>
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              ...
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.monthlyHouseholdIncome}
              onChange={(e) =>
                setValByKey("monthlyHouseholdIncome", e.target.value)
              }
              required
            />
          </span>
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              ...
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.emergencyContactName}
              onChange={(e) =>
                setValByKey("emergencyContactName", e.target.value)
              }
              required
            />
          </span>
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              ...
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.emergencyContactNumber}
              onChange={(e) =>
                setValByKey("emergencyContactNumber", e.target.value)
              }
              required
            />
          </span>
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <Dropdown
              ...
              value={_entity?.emergencyContactRelationship?._id}
              optionLabel="name"
              optionValue="value"
              options={emergencyContactRelationshipOptions}
              onChange={(e) =>
                setValByKey("emergencyContactRelationship", { _id: e.value })
              }
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              ...
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.emergencyContactEmail}
              onChange={(e) =>
                setValByKey("emergencyContactEmail", e.target.value)
              }
              required
            />
          </span>
