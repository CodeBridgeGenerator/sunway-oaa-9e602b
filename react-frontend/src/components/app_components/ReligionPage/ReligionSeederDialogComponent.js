...
import seederData from "./religion.seeder.json";
...
const ReligionSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ReligionSeederDialogComponent);
