...
import seederData from "./courses.seeder.json";
...
const CoursesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(CoursesSeederDialogComponent);
