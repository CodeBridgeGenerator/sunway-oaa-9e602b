...
const SingleIntakePage = (props) => {
  ...
  const [isHelpSidebarVisible, setHelpSidebarVisible] = useState(false);
    ...
    useEffect(() => {
        ...
        client
            .service("intake")
            .get(urlParams.singleIntakeId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
    ...
    }, [props,urlParams.singleIntakeId]);
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                {/* <p>intake/{urlParams.singleIntakeId}</p> */}
            </div>
      ...
      <CommentsSection
        recordId={urlParams.singleIntakeId}
        user={props.user}
        alert={props.alert}
        serviceName="intake"
      />
...
export default connect(mapState, mapDispatch)(SingleIntakePage);
