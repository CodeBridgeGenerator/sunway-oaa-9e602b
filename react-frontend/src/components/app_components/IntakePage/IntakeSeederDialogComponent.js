...
import seederData from "./intake.seeder.json";
...
const IntakeSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(IntakeSeederDialogComponent);
