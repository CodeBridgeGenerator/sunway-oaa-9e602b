...
const [race, setRace] = useState([])
    ...
    useEffect(() => {
        ...
        if (!_.isEmpty(props?.entity)) {
            init = initilization({ ...props?.entity, ...init }, [name,Gender,maritalStatus,religion,race], setError);
        }
        set_entity({...init});
    }, [props.show]);
...
useEffect(() => {
                    ...
                    client
                        .service("gender")
                        .find({ query: { $limit: 10000, $sort: { createdAt: -1 }, _id : urlParams.singleGenderId } })
                        .then((res) => {
                            setGender(res.data.map((e) => { return { name: e['name'], value: e._id }}));
                        })
                        .catch((error) => {
                            console.log({ error });
                            props.alert({ title: "Gender", type: "error", message: error.message || "Failed get gender" });
                        });
                }, []);
...
useEffect(() => {
                    ...
                    client
                        .service("maritalStatus")
                        .find({ query: { $limit: 10000, $sort: { createdAt: -1 }, _id : urlParams.singleMaritalStatusId } })
                        .then((res) => {
                            setMaritalStatus(res.data.map((e) => { return { name: e['name'], value: e._id }}));
                        })
                        .catch((error) => {
                            console.log({ error });
                            props.alert({ title: "MaritalStatus", type: "error", message: error.message || "Failed get maritalStatus" });
                        });
                }, []);
...
useEffect(() => {
                    ...
                    client
                        .service("religion")
                        .find({ query: { $limit: 10000, $sort: { createdAt: -1 }, _id : urlParams.singleReligionId } })
                        .then((res) => {
                            setReligion(res.data.map((e) => { return { name: e['name'], value: e._id }}));
                        })
                        .catch((error) => {
                            console.log({ error });
                            props.alert({ title: "Religion", type: "error", message: error.message || "Failed get religion" });
                        });
                }, []);
...
useEffect(() => {
                    ...
                    client
                        .service("race")
                        .find({ query: { $limit: 10000, $sort: { createdAt: -1 }, _id : urlParams.singleRaceId } })
                        .then((res) => {
                            setRace(res.data.map((e) => { return { name: e['name'], value: e._id }}));
                        })
                        .catch((error) => {
                            console.log({ error });
                            props.alert({ title: "Race", type: "error", message: error.message || "Failed get race" });
                        });
                }, []);
...
const GenderOptions = Gender.map((elem) => ({ name: elem.name, value: elem.value }));
const maritalStatusOptions = maritalStatus.map((elem) => ({ name: elem.name, value: elem.value }));
const religionOptions = religion.map((elem) => ({ name: elem.name, value: elem.value }));
const raceOptions = race.map((elem) => ({ name: elem.name, value: elem.value }));
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <Dropdown id="Gender" value={_entity?.Gender?._id} optionLabel="name" optionValue="value" options={GenderOptions} onChange={(e) => setValByKey("Gender", {_id : e.value})}  />
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <Dropdown id="maritalStatus" value={_entity?.maritalStatus?._id} optionLabel="name" optionValue="value" options={maritalStatusOptions} onChange={(e) => setValByKey("maritalStatus", {_id : e.value})}  />
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <Dropdown id="religion" value={_entity?.religion?._id} optionLabel="name" optionValue="value" options={religionOptions} onChange={(e) => setValByKey("religion", {_id : e.value})}  />
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <Dropdown id="race" value={_entity?.race?._id} optionLabel="name" optionValue="value" options={raceOptions} onChange={(e) => setValByKey("race", {_id : e.value})}  />
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field flex">
            <span className="align-items-center">
                ...
                <Checkbox id="specialConditions" className="ml-3" checked={_entity?.specialConditions} onChange={(e) => setValByKey("specialConditions", e.checked)}  />
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field flex">
            <span className="align-items-center">
                ...
                <Checkbox id="formerSunway" className="ml-3" checked={_entity?.formerSunway} onChange={(e) => setValByKey("formerSunway", e.checked)}  />
            </span>
            <small className="p-error">
