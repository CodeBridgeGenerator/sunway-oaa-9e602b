...
import seederData from "./personalinformation.seeder.json";
...
const PersonalinformationSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(PersonalinformationSeederDialogComponent);
