...
const PersonalinformationPage = (props) => {
    ...
    client
      ...
      .find({
        query: {
          ...
          Gender: urlParams.singleGenderId,
          maritalStatus: urlParams.singleMaritalStatusId,
          religion: urlParams.singleReligionId,
          race: urlParams.singleRaceId,
          $populate: [
            {
              path: "createdBy",
              service: "users",
      ...
      .catch((error) => {
        ...
        props.alert({
          ...
          type: "error",
          message: error.message || "Failed get Personal information",
        });
      });
  ...
  const deleteAll = async () => {
    ...
    const promises = data.map((e) =>
      client.service("personalinformation").remove(e._id),
    );
    await Promise.all(
      promises.map((p) =>
        p.catch((error) => {
  ...
  return (
    <div className="mt-5">
        ...
        <div className="col-6 flex justify-content-end">
          <>
            ...
            <Button
              ...
              role="personalinformation-add-button"
            />
          </>
        </div>
      </div>
      ...
      <AreYouSureDialog
        ...
        onYes={() => deleteRow()}
      />
      <PersonalinformationEditDialogComponent
