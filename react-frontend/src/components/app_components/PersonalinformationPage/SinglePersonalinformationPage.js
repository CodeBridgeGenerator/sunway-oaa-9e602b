...
const SinglePersonalinformationPage = (props) => {
  ...
  useEffect(() => {
    ...
    client
      ...
      .get(urlParams.singlePersonalinformationId, {
        query: {
          $populate: [
            {
              path: "createdBy",
      ...
      .catch((error) => {
        ...
        props.alert({
          ...
          type: "error",
          message: error.message || "Failed get personalinformation",
        });
      });
          ...
          <div className="card w-full">
            <div className="grid ">
              ...
              <div className="col-12 md:col-6 lg:col-3 mb-10">
                ...
                <p className="m-0 ml-3">{_entity?.firstName}</p>
              </div>
              <div className="col-12 md:col-6 lg:col-3 mb-10">
                <label className="text-sm text-gray-600">Surname</label>
                <p className="m-0 ml-3">{_entity?.surname}</p>
              </div>
              <div className="col-12 md:col-6 lg:col-3 mb-10">
                <label className="text-sm text-gray-600">Nationality</label>
                <p className="m-0 ml-3">{_entity?.Nationality}</p>
              </div>
              <div className="col-12 md:col-6 lg:col-3 mb-10">
                <label className="text-sm text-gray-600">NRIC</label>
                <p className="m-0 ml-3">{_entity?.NRIC}</p>
              </div>
              <div className="col-12 md:col-6 lg:col-3 mb-10">
                ...
                <p className="m-0">
                  <i
                    ...
                    className={`pi ${_entity?.specialConditions ? "pi-check" : "pi-times"}`}
                  ></i>
                </p>
              </div>
              <div className="col-12 md:col-6 lg:col-3 mb-10">
                <label className="text-sm text-gray-600">Former Sunway</label>
                <p className="m-0">
                  <i
                    id="formerSunway"
                    className={`pi ${_entity?.formerSunway ? "pi-check" : "pi-times"}`}
                  ></i>
                </p>
              </div>
              <div className="col-12 md:col-6 lg:col-3 mb-10">
              ...
              <div className="col-12 md:col-6 lg:col-3 mb-10">
                <label className="text-sm text-gray-600">Race</label>
                {race.map((elem) => (
