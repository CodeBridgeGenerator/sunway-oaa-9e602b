...
import seederData from "./school.seeder.json";
...
const SchoolSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(SchoolSeederDialogComponent);
