...
const SingleSchoolPage = (props) => {
  ...
  const [isHelpSidebarVisible, setHelpSidebarVisible] = useState(false);
    ...
    useEffect(() => {
        ...
        client
            .service("school")
            .get(urlParams.singleSchoolId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
    ...
    }, [props,urlParams.singleSchoolId]);
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                {/* <p>school/{urlParams.singleSchoolId}</p> */}
            </div>
      ...
      <CommentsSection
        recordId={urlParams.singleSchoolId}
        user={props.user}
        alert={props.alert}
        serviceName="school"
      />
...
export default connect(mapState, mapDispatch)(SingleSchoolPage);
