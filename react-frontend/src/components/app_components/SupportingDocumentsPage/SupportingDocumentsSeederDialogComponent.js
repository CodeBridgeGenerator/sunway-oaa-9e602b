...
import seederData from "./supportingDocuments.seeder.json";
...
const SupportingDocumentsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(SupportingDocumentsSeederDialogComponent);
