...
const SupportingDocumentsPage = (props) => {
    ...
    client
      ...
      .catch((error) => {
        ...
        props.alert({
          ...
          type: "error",
          message: error.message || "Failed get Supporting Documents",
        });
      });
  ...
  const deleteAll = async () => {
    ...
    const promises = data.map((e) =>
      client.service("supportingDocuments").remove(e._id),
    );
    await Promise.all(
      promises.map((p) =>
        p.catch((error) => {
  ...
  return (
    <div className="mt-5">
        ...
        <div className="col-6 flex justify-content-end">
          <>
            ...
            <Button
              ...
              role="supportingDocuments-add-button"
            />
          </>
        </div>
      </div>
      ...
      <AreYouSureDialog
        ...
        onYes={() => deleteRow()}
      />
      <SupportingDocumentsEditDialogComponent
