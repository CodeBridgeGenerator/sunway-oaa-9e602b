...
academicDocuments: _entity?.academicDocuments,
    ...
    return (
        <Dialog header="Edit Supporting Documents" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
