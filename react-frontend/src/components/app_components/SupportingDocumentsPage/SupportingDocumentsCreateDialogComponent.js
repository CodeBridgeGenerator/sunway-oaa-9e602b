...
const SupportingDocumentsCreateDialogComponent = (props) => {
  ...
  const onSave = async () => {
    ...
    try {
      ...
      props.alert({
        type: "success",
        title: "Create info",
        message: "Info Supporting Documents updated successfully",
      });
      ...
      props.alert({
        type: "error",
        title: "Create",
        message: "Failed to create in Supporting Documents",
      });
    }
    setLoading(false);
  };
  ...
  return (
    <Dialog
      header="Create Supporting Documents"
      visible={props.show}
      closable={false}
      onHide={props.onHide}
      modal
    ...
    >
      <div
        ...
        style={{ maxWidth: "55vw" }}
        role="supportingDocuments-create-dialog-component"
      >
