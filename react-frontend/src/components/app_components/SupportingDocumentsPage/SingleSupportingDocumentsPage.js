...
const SingleSupportingDocumentsPage = (props) => {
  ...
  useEffect(() => {
    ...
    client
      ...
      .get(urlParams.singleSupportingDocumentsId, {
        query: {
          $populate: [
            {
              path: "createdBy",
      ...
      .catch((error) => {
        ...
        props.alert({
          ...
          type: "error",
          message: error.message || "Failed get supportingDocuments",
        });
      });
          ...
          <div className="card w-full">
            <div className="grid ">
              <div className="col-12 md:col-6 lg:col-3 mb-10">
                <label className="text-sm text-gray-600">Passport Photo</label>
                <div className="m-0 ml-3">
                  <UploadFilesToS3 type={"single"} />
                </div>
              </div>
              <div className="col-12 md:col-6 lg:col-3 mb-10">
                <label className="text-sm text-gray-600">NRIC Copy</label>
                <div className="m-0 ml-3">
                  <UploadFilesToS3 type={"single"} />
                </div>
              </div>
              <div className="col-12 md:col-6 lg:col-3 mb-10">
                ...
                <p className="m-0 ml-3">{_entity?.educationLevel}</p>
              </div>
              <div className="col-12 md:col-6 lg:col-3 mb-10">
                <label className="text-sm text-gray-600">Qualification</label>
                <p className="m-0 ml-3">{_entity?.Qualification}</p>
              </div>
              <div className="col-12 md:col-6 lg:col-3 mb-10">
                <label className="text-sm text-gray-600">School</label>
                <p className="m-0 ml-3">{_entity?.School}</p>
              </div>
              <div className="col-12 md:col-6 lg:col-3 mb-10">
