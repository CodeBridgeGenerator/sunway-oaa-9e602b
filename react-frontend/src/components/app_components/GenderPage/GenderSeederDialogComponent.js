...
import seederData from "./gender.seeder.json";
...
const GenderSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(GenderSeederDialogComponent);
