...
const TermsandconditionsCreateDialogComponent = (props) => {
  ...
  const onSave = async () => {
    ...
    setLoading(true);
    try {
      await client.service("termsandconditions").patch(_entity._id, _data);
      ...
      props.alert({
        type: "success",
        title: "Edit info",
        message: "Info termsandconditions updated successfully",
      });
  ...
  return (
    ...
    >
      <div
        ...
        style={{ maxWidth: "55vw" }}
        role="termsandconditions-edit-dialog-component"
      >
