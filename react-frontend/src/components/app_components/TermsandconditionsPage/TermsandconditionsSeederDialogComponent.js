...
import seederData from "./termsandconditions.seeder.json";
...
const TermsandconditionsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(TermsandconditionsSeederDialogComponent);
