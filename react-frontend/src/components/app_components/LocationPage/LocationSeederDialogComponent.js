...
import seederData from "./location.seeder.json";
...
const LocationSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(LocationSeederDialogComponent);
