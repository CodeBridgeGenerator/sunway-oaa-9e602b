...
const SingleLocationPage = (props) => {
  ...
  const [isHelpSidebarVisible, setHelpSidebarVisible] = useState(false);
    ...
    useEffect(() => {
        ...
        client
            .service("location")
            .get(urlParams.singleLocationId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
    ...
    }, [props,urlParams.singleLocationId]);
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                {/* <p>location/{urlParams.singleLocationId}</p> */}
            </div>
      ...
      <CommentsSection
        recordId={urlParams.singleLocationId}
        user={props.user}
        alert={props.alert}
...
export default connect(mapState, mapDispatch)(SingleLocationPage);
