...
import seederData from "./relationship.seeder.json";
...
const RelationshipSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(RelationshipSeederDialogComponent);
