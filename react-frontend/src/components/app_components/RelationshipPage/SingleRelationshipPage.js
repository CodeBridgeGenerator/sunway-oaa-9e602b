...
const SingleRelationshipPage = (props) => {
  ...
  useEffect(() => {
    ...
    client
      ...
      .get(urlParams.singleRelationshipId, {
        query: {
          $populate: [
            {
              path: "createdBy",
  ...
  }, [props, urlParams.singleRelationshipId]);
  ...
  return (
    <ProjectLayout>
      <div className="col-12 flex flex-column align-items-center">
          ...
          <div className="flex align-items-center justify-content-between">
            <div className="flex align-items-center">
              <Button
                ...
                onClick={() => goBack()}
              />
              <h3 className="m-0">Relationship</h3>
              <SplitButton
            ...
            {/* <p>relationship/{urlParams.singleRelationshipId}</p> */}
          </div>
        ...
        <CommentsSection
          recordId={urlParams.singleRelationshipId}
          user={props.user}
          alert={props.alert}
...
export default connect(mapState, mapDispatch)(SingleRelationshipPage);
