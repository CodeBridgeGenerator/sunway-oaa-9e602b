...
const RelationshipPage = (props) => {
  ...
  const deleteAll = async () => {
    ...
    const promises = data.map((e) =>
      client.service("relationship").remove(e._id),
    );
    await Promise.all(
      promises.map((p) =>
        p.catch((error) => {
