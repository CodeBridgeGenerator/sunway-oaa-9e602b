...
const ProgrammedetailsPage = (props) => {
    ...
    client
      ...
      .find({
        query: {
          ...
          campus: urlParams.singleCampusId,
          location: urlParams.singleLocationId,
          programmelevel: urlParams.singleProgrammelevelId,
          programme: urlParams.singleCoursesId,
          intake: urlParams.singleIntakeId,
          $populate: [
            {
              path: "createdBy",
              service: "users",
      ...
      .catch((error) => {
        ...
        props.alert({
          ...
          type: "error",
          message: error.message || "Failed get Programme Details",
        });
      });
  ...
  const deleteAll = async () => {
    ...
    const promises = data.map((e) =>
      client.service("programmedetails").remove(e._id),
    );
    await Promise.all(
      promises.map((p) =>
        p.catch((error) => {
  ...
  return (
    <div className="mt-5">
        ...
        <div className="col-6 flex justify-content-end">
          <>
            ...
            <Button
              ...
              role="programmedetails-add-button"
            />
          </>
        </div>
      </div>
      ...
      <AreYouSureDialog
        ...
        onYes={() => deleteRow()}
      />
      <ProgrammedetailsEditDialogComponent
