...
import seederData from "./programmedetails.seeder.json";
...
const ProgrammedetailsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ProgrammedetailsSeederDialogComponent);
