...
const programmelevel = require("./programmelevel/programmelevel.service.js");
const intake = require("./intake/intake.service.js");
const school = require("./school/school.service.js");
const programmedetails = require("./programmedetails/programmedetails.service.js");
const personalinformation = require("./personalinformation/personalinformation.service.js");
const maritalStatus = require("./maritalStatus/maritalStatus.service.js");
const race = require("./race/race.service.js");
const religion = require("./religion/religion.service.js");
const gender = require("./gender/gender.service.js");
const contactInformation = require("./contactInformation/contactInformation.service.js");
const relationship = require("./relationship/relationship.service.js");
const supportingDocuments = require("./supportingDocuments/supportingDocuments.service.js");
const termsandconditions = require("./termsandconditions/termsandconditions.service.js");
...
module.exports = function (app) {
  ...
  app.configure(programmelevel);
  app.configure(intake);
  app.configure(school);
  app.configure(programmedetails);
  app.configure(personalinformation);
  app.configure(maritalStatus);
  app.configure(race);
  app.configure(religion);
  app.configure(gender);
  app.configure(contactInformation);
  app.configure(relationship);
  app.configure(supportingDocuments);
